...
export class DetailsInteractionsPhone extends Component {
    constructor() {
        super();
          this.state = {
          isFlipped: false,
                ...
                <table className="interactions--table">
                    ...
                    <tbody>
                        <tr className="row--container">
                            ...
                            <td className="row--data">{this.props.visibilite.contactPhone.filter( el => {return (el.location==="Vitrine")}).length}</td>
                        </tr>
                            {this.props.transactionsUser.map(transac => {
                                return (
                                    ...
                                    <td className="row--data">{this.props.visibilite.contactPhone.filter( el => {return (el.transaction===transac.transactionId)}).length}</td>
                                    </tr>
...
export default connect(mapStateToProps)(DetailsInteractionsPhone);
