    ...
    render() {
        return (
            <div className="contacts--container">
                {this.props.visibilite.contactMessage.filter(el => {return el.type==="Transaction"}).map(message => {
                ...
                <div className="contact--header">
                    <p className="header-text">{message.name} vous a contacté via votre votre vente récente {message.address ? message.address : ""} </p>
