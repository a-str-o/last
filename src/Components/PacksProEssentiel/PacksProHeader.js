...
export class PacksProHeader extends Component {
    ...
    render() {
        return (
            ...
            <div className="header-background" style={{ backgroundImage: `url(${pack_pro_background})` }}>
                <div className="row">
                    ...
                    <div className="block--left--inner-text--text-align">
                        <h1>
                            <strong>Le Pack Pro Essentiel</strong></h1>
                        <h3 >
                            <span className="text">Boostez votre visibilité et votre réputation digitale</span>
                        </h3>
                        <button className="button button-primary btn--inscription" onClick={()=> this.setState({inscriptionForm : true})}>Demander une Demo</button>
                    </div>
                </div>
            </div>
