...
class StepperEstimationCharDesktop extends Component {
    constructor(props) {
        super(props);
        this.state = {
                    ...
                    <div className="step fourth-step">
                        <div className="form-group row customRow">
                        {
                                ...
                                <>
                                   <div className="col-md-6 col-sm-12 checkbox">
                                    ...
                                    /> 
                                    <label for="balcon">Balcon(s) ou terrasses</label>
                        ...
                        {this.props.estimationStatePro.estimation.bien === 'villa' ? 
                            ...
                            {this.props.estimationStatePro.estimation.bien === 'appartement' ? 
                                ...
                                <div className="col-md-6 col-sm-12 checkbox">
                                    <input 
                                        ...
                                        /> 
                                        <label for="concierge">Residence fermée</label>
                                </div>
                                </>
                                ): ''
                            }
                            ...
                            {this.props.estimationStatePro.estimation.bien === 'villa' ? 
                                ...
                                */}
                                  <div className="col-md-12 col-sm-12 col-type-chauffage" style={{marginBottom:"15px"}}>
                                    <div className="row">
                                        <div className="col-12">
                                            <div className="row">
                                                <div className="col-12">
                    ...
                    (
                      <>
                        <div className="information-field">
                          <h3><i class="fas fa-ruler-combined"></i> Surfaces annexes</h3>
                          <p>
                        ...
                        <div className="information-field">
                            <h3><i class="fas fa-bed"></i> Cave et parking doivent être titrée</h3>
                            <p>
                                Les surfaces annexes titrées seront pris en compte avec une pondération dans le calcul final du prix au m<sup>2</sup>.
                            </p>
                        </div>
...
export default connect(mapStateToProps)(StepperEstimationCharDesktop);