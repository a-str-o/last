                                                ...
                                                <div className="col-12">
                                                    <div className="row">
                                                        ...
                                                        <div className="col-12">
                                                            ...
                                                            />
                                                            <CSSTransition appear={true} unmountOnExit in={this.state.surfaceHabitableError} timeout={300} classNames="additionalFields">
...
export default connect(mapStateToProps)(withRouter(EstimationStepperForm));