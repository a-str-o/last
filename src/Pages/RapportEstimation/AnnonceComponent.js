...
<p className="desc--annonce">Annonce pour {this.props.bien==="appartement" ? 'un appartement' : 'une villa'} de {this.props.chambres} chambre pour une surface de {this.props.surface} m<sup>2</sup></p>
