...
componentDidMount(){
  ...
  img_supermarches.src=encodedData
      ...
      render() {
        return (<>
<img className="image--restaurants" id="image--restaurants" alt="notation des retaurants autour du bien"></img>
<img className="image--ecoles" id="image--ecoles" alt="notation des ecoles autour du bien"></img>
<img className="image--pharmacies" id="image--pharmacies"alt="notation des pharmacies autour du bien"></img>
<img className="image--supermarches" id="image--supermarches"alt="notation des supermarchés autour du bien"></img>
